...
//    weak var delegate: HouseCellDelegate?
    var onFavoriteTapped: ((Bool) -> Void)? // -1 создал замыкание
...
//        imageViewHouse.image = nil
        ...
        onFavoriteTapped = nil // -1 обновляем при переиспользовании ячейки
    }
...
//        delegate?.didToggleFavorite(in: self, state: isFavorite)
        onFavoriteTapped?(isFavorite) //-3 вызываю замыкание
    }
